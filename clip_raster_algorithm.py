...
class ClipRaster(GdalAlgorithm):
    INPUT = 'INPUT'
    EXTENT = 'PROJWIN'
    OVERCRS = 'OVERCRS'
    NODATA = 'NODATA'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.TYPES = [self.tr('Use Input Layer Data Type'), 'Byte', 'Int16', 'UInt16', 'UInt32',
    ...
    def getConsoleCommands(self, parameters, context, feedback, executing=True):
        ...
        bbox = self.parameterAsExtent(
            parameters, self.EXTENT, context, inLayer.crs())
        override_crs = self.parameterAsBoolean(
            parameters, self.OVERCRS, context)
        ...
        if override_crs and crs.isValid():
            arguments.append(
                '-a_srs {}'.format(GdalUtils.gdal_crs_string(crs)))
        ...
        arguments.append('-of')
        arguments.append(QgsRasterFileWriter.driverForExtension(
