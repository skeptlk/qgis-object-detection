...
from .cal_dist_ang import cal_dist, azimuthAngle
...
def boundary_regularization(img, epsilon=6) -> np.array:
    h, w = img.shape[0:2]
    ...
    # Get the length and azimuth of each edge
    ...
    # Orientation correction, rotate around the center point to be perpendicular or parallel to the main direction
    correct_points = []
    ...
    # Adjacent edge correction, take the intersection point vertically, translate the short edge parallel or add a line
    final_points = []
